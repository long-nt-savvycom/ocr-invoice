...
from azure.ai.formrecognizer import AddressValue
from azure.ai.formrecognizer import CurrencyValue
from datetime import date



# Custom JSON encoder to handle AddressValue and CurrencyValue
...
# Replace with your Azure Form Recognizer key and endpoint
...
def analyze_layout():
    ...
    with open("invoice_output_10.json", "w") as json_file:
